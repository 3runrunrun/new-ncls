  ...
  <script src="<?php echo base_url() ?>assets/js/vendors/ui/jquery.matchHeight-min.js" type="text/javascript"></script>
  <script src="<?php echo base_url() ?>assets/js/vendors/ui/jquery-sliding-menu.js" type="text/javascript"></script>
  <script src="<?php echo base_url() ?>assets/js/vendors/slicks/slick.min.js" type="text/javascript"></script><!-- slick -->
  <script src="<?php echo base_url() ?>assets/js/vendors/ui/screenfull.min.js" type="text/javascript"></script>
  <script src="<?php echo base_url() ?>assets/js/vendors/extensions/pace.min.js" type="text/javascript"></script>
  <!-- /build-->
  <!-- BEGIN VENDOR JS-->
  ...
  <script src="<?php echo base_url() ?>assets/js/vendors/datatables/dataTables.responsive.min.js" type="text/javascript"></script><!-- datatable -->
  <script src="<?php echo base_url() ?>assets/js/vendors/datatables/dataTables.rowReorder.min.js" type="text/javascript"></script><!-- datatable -->
  <script src="<?php echo base_url() ?>assets/js/vendors/datatables/dataTables.fixedColumns.min.js" type="text/javascript"></script><!-- datatable -->
  <script src="<?php echo base_url() ?>assets/js/vendors/datatables/buttons.colVis.min.js" type="text/javascript"></script><!-- datatable btn -->
  <script src="<?php echo base_url() ?>assets/js/vendors/datatables/dataTables.buttons.min.js" type="text/javascript"></script><!-- datatable > use in export -->
  <script src="<?php echo base_url() ?>assets/js/vendors/datatables/dataTables.select.min.js" type="text/javascript"></script><!-- datatable -->
  <script src="<?php echo base_url() ?>assets/js/vendors/datatables/buttons.bootstrap4.min.js" type="text/javascript"></script><!-- datatable > use in export -->
  <script src="<?php echo base_url() ?>assets/js/vendors/datatables/jszip.min.js" type="text/javascript"></script><!-- datatable > use in export -->
  <script src="<?php echo base_url() ?>assets/js/vendors/datatables/pdfmake.min.js" type="text/javascript"></script><!-- datatable > use in export -->
  <script src="<?php echo base_url() ?>assets/js/vendors/datatables/vfs_fonts.js" type="text/javascript"></script><!-- datatable > use in export -->
  <script src="<?php echo base_url() ?>assets/js/vendors/datatables/buttons.html5.min.js" type="text/javascript"></script><!-- datatable > use in export -->
  <script src="<?php echo base_url() ?>assets/js/vendors/datatables/buttons.print.min.js" type="text/javascript"></script><!-- datatable > use in export -->
  ...
  <script src="<?php echo base_url() ?>assets/js/vendors/charts/raphael-min.js" type="text/javascript"></script><!-- chart -->
  <script src="<?php echo base_url() ?>assets/js/vendors/charts/morris.min.js" type="text/javascript"></script><!-- chart -->
  ...
  <script src="<?php echo base_url(); ?>assets/js/fullscreenSearch.min.js" type="text/javascript"></script>
  <!-- /build-->
  <!-- END ROBUST JS-->
  <!-- BEGIN PAGE LEVEL JS-->
  ...
  <script src="<?php echo base_url() ?>assets/js/vendors/datatables/datatable-fixed-column.min.js" type="text/javascript"></script><!-- datatable -->
  <script src="<?php echo base_url() ?>assets/js/vendors/datatables/datatable-button-basic.min.js" type="text/javascript"></script><!-- datatable -->
  <script src="<?php echo base_url() ?>assets/js/vendors/datatables/datatable-colvis.min.js" type="text/javascript"></script><!-- datatable -->
  ...
  <script src="<?php echo base_url() ?>assets/js/vendors/datatables/datatable-print.min.js" type="text/javascript"></script><!-- datatable > simple print -->
