...
class C_Pros_Inten_Eksten extends CI_Controller {
  ...
  {
    $data['ekstensifikasi'] = $this->eks->get_target_eksten('a.id, UPPER(e.alias_area) as alias_area, UPPER(e.nama) as nama_area, UPPER(f.nama) as nama_detailer, UPPER(c.nama) as nama_outlet, UPPER(d.nama) as nama_customer, a.target');
