...
class C_Pros_Inten_Eksten extends CI_Controller {
  ...
  {
    $data['ekstensifikasi'] = $this->eks->get_target_eksten('id, UPPER(alias_area) as alias_area, UPPER(nama_area) as nama_area, UPPER(nama_detailer) as nama_detailer, UPPER(nama_outlet) as nama_outlet, UPPER(nama_customer) as nama_customer, target');
